...
//  药品版本管理的列表信息
	    private inversionListUrl = '/ipharmacare-distributed-yb-web/version/list2/XM/';
// 版本管理的修改页面     根据id查看
...
//  药品添加中的下拉列表    
    private selectListURL = '/ipharmacare-distributed-yb-web/version/list2/comboBox/XM/'
