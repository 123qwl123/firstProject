...
import {ProjectVersionManagementSave} from './project_version_management_save';
...
@Component({
	...
	styleUrls:['Project_version_management.component.css','../../app.component.css'],
...
//  点击添加版本按钮保存版本
     saveVersion():void{
     	this.projectVersionManagementSave.summary = this.name;
     	this.projectVersionManagementSave.description = this.description;
