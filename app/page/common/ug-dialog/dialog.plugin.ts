...
@Component({
    selector: 'my-dialog',
    template: `
    <div class="dialog" [hidden]="!dialogInfo.isShow" >
        <div class="dialog-message" [hidden]="!dialogInfo.tip"  [class.dialog-success]="dialogInfo.status == 'success'"  [class.dialog-resMessage]="dialogInfo.resMessage == true" >
            ...
            <div *ngIf="dialogInfo.resMessage"  style="font-size:13px;width:100%;height:100%;padding:10px;line-height:30px;text-align:left;">
                    <div  style="display:inline-block;float:left;width:20px;height:100%;">
                        <span class="{{dialogInfo.status}}-image"></span>
                    </div>
                    <div style="display:inline-block;float:left;width:158px;height:100%;">
                        {{dialogInfo.message}}
                    </div>
        ...
        <div [hidden]="!dialogInfo.isConfirm" class="confirm center">
            ...
            <div style="height:70px;">
                ...
                <div class="center" style="font-size:13px;color:#999;">{{dialogInfo.noMessage}}</div>
            </div>
            <div style="border-top:1px solid #ddd;" class="center" >
