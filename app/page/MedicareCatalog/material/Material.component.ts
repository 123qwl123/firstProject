...
@Component({
	...
	styleUrls:['Material.component.css','../../../app.component.css'],
...
export class MaterialComponentApp {
	...
	addItemTemplate:boolean = false;//添加药品模板
	...
	*-------------------
	...
	getDataTree(dictValue?: string,versionId?:string){
	 ...
	 /*版本管理*/
    versionControl(){
    	let link:any= ['page/all_version_management/Material_version_management/'+"1"];
	...
	* 拖拽方法和拖拽错误提示
	...
	private addData(): void {
		...
		/*同级*/
		console.log(this.curTreeNode.data)
		if(this.addlevel == 1){
	...
	private updateData(): void {
	 	...
	 	if(modifyData.summary && this.testNameResult && this.Itemcode && this.YBcode){
